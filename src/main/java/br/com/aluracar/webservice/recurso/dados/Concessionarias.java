...
public class Concessionarias {
	...
	private static final Stream<Concessionaria> CONCESSIONARIAS = Stream.of(
	...
	public static Stream<Concessionaria> listaTodas(LimitesExtremos limites, LatLng centro) {
