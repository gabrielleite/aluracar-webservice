...
public class MainServer {
	...
	/**
	 * Starts Grizzly HTTP server exposing static content, JAX-RS resources and web
	 * sockets defined in this application.
	 *
	 * @param webRootPath
...
//			System.out.println(uri);
			...
			try {
				fileStream = webRootPath == null ? MainServer.class.getResourceAsStream(WEB_ROOT + uri)
